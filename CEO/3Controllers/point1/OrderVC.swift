...
class OrderVC: BaseViewController {
    ...
    let questions: [String] = [
        /**
         E: To confirm that (--) and you are two different existences, each of you must be one self-generated entity and exist as different without your mind\'s labels of \"(--)\" and \"you\".\nThese three qualities are necessary for (--) and you as a genuine claim of individual existence.
        ...
        */
        "To confirm that (--) and you are two different existences, each of you must be one self-generated entity and exist as different without your mind's labels of \"(--)\" and \"you\".\nThese three qualities are necessary for (--) and you as a genuine claim of individual existence.".localized,
        ...
        */
        "1. If she is not one entity, she cannot be regarded as one. If she is not one, there can't be a second or third entity,etc.\n2. If she is a product of everything else and their essence, she does not have an individual essence.\n3. The body and mind can exist without the label 'person'; they only became a person when you applied that label and believed it.".localized
    ]
